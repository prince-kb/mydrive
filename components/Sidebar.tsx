  ...
  return (
    <aside className='sidebar'>
      <Link href="/">
        ...
        <Image src="/assets/icons/logo-full-brand.svg" alt='logo' width={52} height={52} className='lg:hidden' />
      </Link>
      ...
      <div className="sidebar-user-info">
        <Image src={avatar} alt="logo" width={44} height={44} className='sidebar-user-avatar' />
